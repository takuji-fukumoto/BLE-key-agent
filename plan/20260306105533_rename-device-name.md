...
## Phase2: 実装（コア）
- [x] [Phase2] `src/common/uuids.py` DEVICE_NAME定数変更
- [x] [Phase2] `src/ble_sender/api_types.py` デフォルト値変更
- [x] [Phase2] `src/ble_sender/main.py` デフォルト値・docstring・help文字列変更

## Phase3: 実装（結合）
- [x] [Phase3] `tests/test_key_receiver.py` assertion文字列更新
- [x] [Phase3] `tests/test_gatt_server.py` assertion文字列更新
- [x] [Phase3] `sample/raspi_receiver/apps/cli_receiver/main.py` argparseデフォルト更新
- [x] [Phase3] `sample/unihiker_receiver/main.py` デフォルト値・argparse更新
- [x] [Phase3] `scripts/run_mac.sh` コメント更新
- [x] [Phase3] `sample/scripts/run_raspi.sh` echoメッセージ更新
- [x] [Phase3] `sample/scripts/run_unihiker.sh` echoメッセージ更新

## Phase4: テスト
- [x] [Phase4] pytest全テスト実行・パス確認
- [x] [Phase4] `grep -r "RasPi-KeyAgent"` で残存参照チェック（poc/plan以外）

## Phase5: 仕上げ
- [x] [Phase5] `docs/spec-ble-protocol.md` デバイス名・シーケンス図更新
- [x] [Phase5] `docs/spec-raspi-receiver.md` デフォルト値更新
- [x] [Phase5] `docs/spec-mac-agent.md` UIモックアップ更新
- [x] [Phase5] `README.md` 実行例・コード例・BLE仕様テーブル更新
