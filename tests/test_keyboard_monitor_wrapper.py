"""Unit tests for ble_sender.keyboard_monitor wrapper."""
...
from ble_sender.keyboard_monitor import KeyboardMonitor  # noqa: E402
...
async def test_wrapper_uses_external_queue() -> None:
    ...
    with patch("ble_sender.keyboard_monitor.KeyMonitor") as key_monitor_cls:
...
async def test_next_event_timeout() -> None:
    ...
    with patch("ble_sender.keyboard_monitor.KeyMonitor"):
        monitor = KeyboardMonitor(queue=queue)
