...
Reference: reports/1.3inch_LCD_HAT_python/config.py
"""
...
_PROJECT_ROOT = Path(__file__).resolve().parents[4]  # sample/../../../..
FONT_DIR: Path = _PROJECT_ROOT / "reports" / "1.3inch_LCD_HAT_python" / "Font"
