...
if [ -z "$FOUND_PYTHON" ]; then
    ...
    echo "    # ~/.bashrc に以下を追加して source ~/.bashrc:"
    ...
    echo ""
    echo "  または pyenv build（時間がかかります）:"
    echo "    pyenv install 3.11.4 && pyenv global 3.11.4"
    echo ""
...
echo ""
echo "起動方法:"
echo "  ./sample/scripts/run_unihiker.sh"
echo "=========================================="
